...
public enum AFWeaponType {
    ...
    SHORTSWORD("shortsword", mat -> new AFTieredItem(mat, 2.0F, 2.0F, 0.0F, 0.0F, true, () -> Map.of(
            AFSpecialties.FINESSE.get(), 1,
            AFSpecialties.EXECUTE.get(), 1
    ))),

    DAGGER("dagger", mat -> new AFThrowableTieredItem(mat, 1.0F, 2.2F, 0.15F, 0.0F, false, 3, 4.0F, () -> Map.of(
    ))),
    ...
    BATTLEAXE("battleaxe", mat -> new AFTieredItem(mat, 7.0F, 0.8F, -0.1F, 0.0F, false, () -> Map.of(
    ...
    JAVELIN("javelin", mat -> new AFThrowableTieredItem(mat, 3.0F, 1.2F, 0.0F, 1.25F, false, 4.5F, 3.0F, () -> Map.of(
    ))),

    SPEAR("spear", mat -> new AFThrowableTieredItem(mat, 3.0F, 1.1F, 0.0F, 1.25F, false, 5.0F, 2.5F, () -> Map.of(
    ))),
    ...
    HALBERD("halberd", mat -> new AFTieredItem(mat, 4.0F, 1.2F, 0.0F, 1.25F, true, () -> Map.of(
            AFSpecialties.TWO_HANDED.get(), 1
    ))),
    ...
    ODACHI("odachi", mat -> new AFTieredItem(mat, 3.0F, 1.5F, 0.0F, 1.0F, true, () -> Map.of(
            AFSpecialties.SWEEPING.get(), 2,
            AFSpecialties.TWO_HANDED.get(), 1
    ))),
